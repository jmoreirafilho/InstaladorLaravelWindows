#!/bin/bash
clear
echo "\n---- Iniciando instalacao do ambiente de Desenvolvimento PHP com Laravel Framework ---"
...
sudo composer create-project --prefer-dist laravel/laravel /www/laravel

echo "\n\n--- Configurando Mapeamento do Projeto ---"
sudo cp /www/config/laravel.conf.tpl /etc/apache2/sites-available/laravel.conf
